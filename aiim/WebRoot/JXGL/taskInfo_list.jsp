...
//更新界面
function updateUI() {
	window.showModalDialog("/aiim/JXGL/taskinfoManageAction_updateUI.action?editTaskInfoId="+$('#editTaskInfoId').val(),"newwindow","dialogWidth=500px;dialogHeight=400px;center=yes;scroll=no;status=no;resizable=no;help=no;location=no");
}

//通过任务主题点击更新界面
function updateTask(editTaskInfoId) {
	var returnValue = window.showModalDialog("/aiim/JXGL/taskinfoManageAction_updateUI.action?editTaskInfoId="+editTaskInfoId,"newwindow","dialogWidth=500px;dialogHeight=400px;center=yes;scroll=no;status=no;resizable=no;help=no;location=no");
...
$(function() {
  ...
  <body>
  <s:form id="conditionForm" action="taskinfoManageAction_show" namespace="/JXGL">
			...
			<tr>
				<td>
					<div style="float:left;margin-left: 10px;">
					    <c:if test="${publishOwn=='y'}">
					    	<input type="image" src="images/new.gif" onmouseover="changeImage(this,'new2.gif')" onmouseout="changeImage(this,'new.gif')" onclick="showRW()"/>
					    	<input type="image" id="editB" disabled="disabled" src="images/edit3.gif" onmouseover="changeImage(this,'edit2.gif')" onmouseout="changeImage(this,'edit.gif')" onclick="updateUI()"/>
					    	<input type="image" id="deleteB" disabled="disabled" src="images/del3.gif" onmouseover="changeImage(this,'del2.gif')" onmouseout="changeImage(this,'del.gif')" onclick="deleteBatch()"/>
						</c:if>	
					...
					<div style="margin-right:10px; display:block; float:right; color:blue;font-size:14px;">
						<font style="font-weight:bold;">当前位置：</font>绩效管理&gt;&gt;任务管理
					</div>		
				</td>
			</tr>
			<tr>
							...
							<td style="height:25px" class="borderTop">
								<table style="width:100%;height:25px" cellspacing="0" cellpadding="0">
							            <tr>
							                ...
							                <ul id="tags">
										   		<li class="selectTag" id="l1"><a href="javascript:search('y')">已发布任务</a></li>
										   		<c:if test="${receiveOwn=='y' && publishOwn=='y'}">
													<li id="l2"><a href="javascript:search('n')">任务草稿</a></li>
												</c:if>
										  	</ul>
										  
							                <a href="javascript:search('y');"></a><a href="javascript:search('n');"></a></td>
					...
					<table id="showTable" width="100%" style="margin:0px; border: #104da6 1px solid;" cellspacing="1px" cellpadding="0px" >						
						...
						<s:iterator value="#request.taskInfos" var="task" status="stau">
							<tr id="tr<s:property value="#task.iD"/>" bgcolor="#eef5ff" id="row1" onclick="clickRow(this);setEdit();setDelete();">
								<td align="center"><input type="checkbox" id="td<s:property value="#task.iD"/>" name="checkId" value="<s:property value="#task.iD"/>"/></td>
			...
			<tr>
				<td>
					<table width="100%" style="font-size: 12px;">
						 <tr>
						    <td>
						       <input type="checkbox" id="SelectAll" accesskey="S"  name="SelectAll" onclick="selectAll(this);setEdit();setDelete();" title="选中/取消 所有记录(S)"  /><label for="SelectAll">全选</label>
							</td>
