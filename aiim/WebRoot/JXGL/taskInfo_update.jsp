...
function setPublish(flag) {
  ...
  <s:form id="myForm" action="taskinfoManageAction_update" namespace="/JXGL">
	        ...
	        <td>
	            <table width="100%">
	            	<tr>
				        <td class="text">&nbsp;主题：</td>
				        <td align="left">
					        <input  id="title" type="text" name="title" value="${taskinfo.title}" style="width:380px;"/></td>
					</tr>
			        <tr>
				        <td class="text">&nbsp;发&nbsp;送&nbsp;给&nbsp;：</td>
				        <td align="left">
				        	<input type="hidden" id="receiveIds" name="receiveIds" value="${taskinfo.receiveIds}">
					        <input id="taskReceivers" name="taskReceivers" type="text" value="${taskinfo.receiveNames}" readonly="readonly" style="width:380px;"/><input type="button" id="choice" value="..." onclick="javascript:openWindow('receiver_choice.jsp','480','360');"/></td>
					</tr>
			        <tr>
				        <td class="text">&nbsp;内容：</td>
				        <td align="left" colspan="3">
				           <textarea id="content" name="content" rows="15" style="width:380px;">${taskinfo.content}</textarea>
				        </td>
					</tr>
				</table>
	        </td>
