...
$(function() {
  ...
  <body>
  <s:form id="conditionForm" action="taskinfoManageAction_receiveTask" namespace="/JXGL">
			...
			<tr>
				<td>
					...
					<div style="margin-right:10px; display:block; float:right; color:blue;font-size:14px;">
						<font style="font-weight:bold;">当前位置：</font>我的工作空间&gt;&gt;我负责的任务
					</div>
				</td>
			</tr>
			<tr>
			     ...
			     <fieldset>
			       <table class="findTB">
			         <tr>
			           ...
			           <td align="left"><s:textfield id="fromUserName" name="fromUserName"/></td>
			         </tr>
			      	 <tr>
