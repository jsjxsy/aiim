...
<html>
  <head>
    ...
    //打开日期输入页面
        ...
        //打开新增对话框
		function showItem(NBXH,type)
		{
		    var obj = new Object();
		    obj.win = window;
		    obj.NBXH = NBXH;
		    obj.type = type;
			var returnValue = window.showModalDialog("dispatchDocItem.jsp",obj,"dialogWidth=700px;dialogHeight:500px;center=yes;help=no;resizable=no;status=no;scroll=no;");
			if(returnValue == true){
		...
		function archiving(){
			if($("input:checked[name='NBXHs']").length <= 0){
	            ...
	            var archivesTypeId = window.showModalDialog("archiving.jsp","newwindow","dialogWidth=250px;dialogHeight:60px;center=yes;help=no;resizable=no;status=no;scroll=no;");
			    if(archivesTypeId != null){
			       $("#delForm").attr("action","GWGL/officeDocAction_archivingDoc.action")
			       $("#delForm").append("<input type='hidden' name='archivesTypeId' value='"+archivesTypeId+"'/>");
			       $("#delForm").ajaxSubmit({
				        ...
				        error:function(XMLHttpRequest, textStatus){alert("归档失败！ "+textStatus+","+XMLHttpRequest.status);}
			       });
			    }
            }	
		}
		     ...
		     <tr>
			  <td>   
			     <table width="100%" cellpadding="0" cellspacing="0" border="0">
			       <tr>
				       <td>
                         <input type="image" src="images/new.gif"  onclick="showItem(null,'add')" onmouseover="changeImage(this,'new2.gif')" onmouseout="changeImage(this,'new.gif')"  />
						 <input type="image" src="images/del.gif" id="del" onmouseover="changeImage(this,'del.gif')" onmouseout="changeImage(this,'del.gif')"/>
			       ...
			       <table class="findTB"  >
						...
						<tr style="height: 26px" align="left">
							...
							<td>
								...
								<input  type="image" style="padding-right:10px;" src="images/dropdownTime.gif" onclick="PopUpCalendar('bmgdDate',true)"  />至
								<input type="text" id="bmgdDate2" style=" margin-left:5px; width: 118px;"/>
								<input  type="image" style="padding-right:10px;" src="images/dropdownTime.gif" onclick="PopUpCalendar('bmgdDate2',true)"  />
							</td>
						</tr>
			...
			<tr>
				<td align="center" height="25px">
					...
					<table id="showTable" cellpadding="0px" cellspacing="1px">						
						...
						<tbody>
						<form action="GWGL/officeDocAction_delDoc.action" method="post" name="delForm" id="delForm" style="margin: 0;padding: 0;">
						    <input type="hidden" name="type" value="FW"/>
						    ...
						    <tr  bgcolor="#eef5ff" id="row1" onclick="selectRow(this)" title="双击查看"  ondblclick="showItem('123456','view')">
								<td align="center"><input type="checkbox" name="NBXHs" value="10001"/></td>
								<td>1</td>
								<td>200302121</td>
								<td>测试公文1</td>
								<td>组织部</td>
							...
							<tr bgcolor="#e0edff" id="row2" onclick="selectRow(this)" title="双击查看" ondblclick="showItem('123456','view')">
								<td align="center"><input type="checkbox" name="NBXHs" value="10002"/></td>
								<td>2</td>
								<td>200302122</td>
								<td>测试公文2</td>
								<td>组织部</td>
