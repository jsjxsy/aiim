...
<html>
  <head>
   ...
   function archived(){
	   ...
	   OfficialArchivesInfoManageDWR.archiviedBatchOfficialArchivesInfos(NBXHS,officialArchivesTypeID,archivesTypeID,childArchivesTypeID,archivesFondID,ArchivedCallBack);
