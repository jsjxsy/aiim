...
<html>
  <head>
	...
	<script type="text/javascript" src="dwr/interface/UserRolesArchivesTypeManageDWR.js"></script>
	...
	function modifyArchivesType(){
		...
		var UserID = ${RoleID};
		UserRolesArchivesTypeManageDWR.modifyUserRolesArchivesType(keys,UserID,callback);
	  }
	
	function callback(data){
		if(data){
			alert("修改角色档案资源访问权限成功！");
		}else{
			alert("修改角色档案资源访问权限失败！");
		}
	}
	</script>
	<style type="text/css">
