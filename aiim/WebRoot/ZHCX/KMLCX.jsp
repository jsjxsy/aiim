 ...
 VERTICAL-ALIGN: middle; 
  ...
  <body style="margin: 0;padding: 0;">  
	  <s:if test="#request.errMsg != null">
		     ...
		     <tr>
			  <td>   
			     <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 0;padding: 0;" >
			       <tr>
				       <td>
                         <input type="image" id="search" src="images/find.gif" alt="打开查询页面(Q)" onclick="showFind()"/>
					    <%-- <input type="image"  src="images/advfind.gif"  onmouseover="changeImage(this,'advfind2.gif')" onmouseout="changeImage(this,'advfind.gif')" />
					     <input type="image"  src="images/GJZJS.gif"  onmouseover="changeImage(this,'GJZJS2.gif')" onmouseout="changeImage(this,'GJZJS.gif')" onclick="showADFind1()"/> --%>
					   ...
					   <div id="location" style="margin-right: 2px; width: 280px; display: inline-block; float: right; margin-top: 0px; color: blue; text-align: right;">
						  <font style="font-size: 12px;"><b>当前位置：</b>综合查询&nbsp;&gt;&gt;&nbsp;&nbsp;跨门类查询</font>
					   </div>
		...
		<!-- 关键字检索FORM表单  -->
		<form name="findByKeyWordForm" action="<%=basePath%>ZHCX/integratedQueryAction_findArchivesCountsByKeyWord.action" method="post" id="keyWordQuery" style="margin: 0;padding: 0;">
			<input type="hidden" id="archivesTypeIdstr" name="archivesTypeIdstr" value="${request.archivesTypeIdstr}">
			<center><SPAN style="font-size: 15px;">关键字：</SPAN><input type="text" name="keyWord" value="${request.keyWordSQL }" style="width: 300px;height: 25px;">&nbsp;&nbsp;<input type="button" onclick="keyValueQuery()" value="&nbsp;查 询&nbsp;"/> </center>
		</form>
