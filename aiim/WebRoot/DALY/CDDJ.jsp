  ...
  <head>
    ...
    <script type="text/javascript" >
       //打开日期输入页面
		...
		//弹出借档登记窗口
		function showBorrow(){
		  var returnValue = window.showModalDialog("<%=basePath%>DALY/archivesUseAction_findDefaultDataForDJ.action?useType=CD","newwindow","dialogWidth=550px;dialogHeight=450px;center=yes;scroll=no;status=no;resizable=no;help=no;location=no");
		...
		function showDJXX(registerID){
			alert(registerID);
		   window.showModalDialog("<%=basePath%>DALY/archivesUseAction_findArchivesUseRegisterByID.action?useType=CD&registerID="+registerID,"newwindow","dialogWidth=550px;dialogHeight=450px;center=yes;scroll=no;status=no;resizable=no;help=no;location=no");
		}
	</script>
</head>
<body>
			     ...
			     <table width="100%" cellpadding="0" cellspacing="0" border="0">
			       <tr>
				       <td>
							...
							-->
							<input type="image" src="images/CDDJ.png" onmouseover="changeImage(this,'CDDJ1.png')" onmouseout="changeImage(this,'CDDJ.png')" onclick="showBorrow();"/>												
						</td>
						<td>
							<div id="location" style="margin-right: 2px; width: 280px; display: inline-block; float: right; margin-top: 0px; color: blue; text-align: right;">
							  <font style="font-size: 12px;"><b>当前位置：</b>利用管理&nbsp;&gt;&gt;&nbsp;&nbsp;查档登记</font>
						    </div>					
						</td>
				  </tr>
				  </table>		
			...
			<tr>
			  <td align="center" id="find" style="display:none;width:100%;">
			    <form action="DALY/archivesUseAction_findUseList.action" method="post" name="conditionForm" id="conditionForm" style="margin: 0px; padding: 0px;">
			      <input type="hidden" name="useType" value="CD"/>
			      <input type="hidden" name="dataPageInfo.currentPage" id="currentPage" value="1">
			     <fieldset>
			       <table class="findTB">
			         <tr>
			           <td align="right" class="text">查档人</td>
			         ...
			         <tr>
			           <td align="right" class="text">查档人部门</td>
			      	 ...
			      	 <tr>
			           <td align="right" class="text">查档日期</td>
			           <td class="text">
