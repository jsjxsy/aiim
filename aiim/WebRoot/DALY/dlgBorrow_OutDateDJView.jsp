				...
				<tr>
					<td align="center">
						...
						<form action="DALY/archivesUseAction_useRegist.action" method="post" style="margin: 0;padding: 0">
							...
							<input type="image" src="images/DYCHD.gif" style="background-color: #eeeeee;" onclick="alert('打印催还单...');"  onmouseover="changeImage(this,'DYCHD1.gif')"  onmouseout="changeImage(this,'DYCHD.gif')"/>
							<!-- 
