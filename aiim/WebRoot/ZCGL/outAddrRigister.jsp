...
function showDetail()
{
	window.showModalDialog("<%=basePath%>/ZCGL/outDetailInfo.jsp","newwindow","dialogWidth=600px;dialogHeight:400px;top=0;left=0;status:no; toolbar=no;menubar=no;scroll:0;location:yes; resizable=no;location=n");
}
	...
	<tr>
		...
		<td>
			<div style="margin-right:2px; display:inline-block; width:300px; color:blue; float:right; margin-top:5px;" align="right">
				<font style="font-size:12px;font-weight:bold;">当前位置：</font>转出管理&nbsp;&gt;&gt;&nbsp;去向登记</div >
		</td>
	</tr>	
</table>
...
<table width="100%" style="margin:0px; font-size:12px;" cellspacing="0" cellpadding="0">
	<tr >
		<td>
			<span>选择文件:</span><input type="file" >&nbsp;&nbsp;
	...
	<tr>
		<td>
			<table id="showTable" width="100%" style="margin:0px; border: #104da6 1px solid; font-size:12px;" cellspacing="1px" cellpadding="0px" >						
				...
				<tbody  id="showBody" >
				<tr id="234" bgcolor="#eef5ff" style="height: 20px;" title="双击查看详细信息" ondblclick="showDetail(this)">
				...
				<tr id="235" bgcolor="#e0edff" style="height: 20px;" title="双击查看详细信息" ondblclick="showDetail(this)">
					<td><input type="checkbox"/></td>
					<td>2</td>
					<td>455</td>
					<td>北京BB公司</td>
