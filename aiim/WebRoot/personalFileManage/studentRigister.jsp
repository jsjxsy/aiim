...
<table width="100%" style="margin:0px; font-size:12px;" cellspacing="0" cellpadding="0">
    <tr>
       <td>
         <fieldset>
           <form action="XSDAGL/importStudentInfo.action" method="post" enctype="multipart/form-data">
           <table align="center" style="font-size: 12px;">
	            <tr>
			      <td align="center">
<%--			        <input type="radio" name="importType" value="2" checked="checked"/>博士后--%>
			        <input type="radio" name="importType" value="3" checked/>博士生
			        <input type="radio" name="importType" value="4"/>硕士生
			        <input type="radio" name="importType" value="5"/>本科生
			      </td>
			    </tr>
			    <tr>
			      <td>
