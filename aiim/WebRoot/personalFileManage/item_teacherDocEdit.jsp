...
<form action="JZGDAGL/teacherFileManageAction_updateTeacherDocInfo.action" method="post" id="form1" name="form1">
<input name="teacherDocsInfo.ID" type="hidden" value="${teacherDocsInfo.ID}"/>
<fieldset style="width: 100%; margin-top: 10px;margin-left: 5px; margin-right: 5px; ">
	...
	<table style="width: 100%;" >
		<tr>
			...
			<td>
			   <s:select list="%{#request.teacherDocsTypes}" listKey="ID" listValue="name" value="%{#request.teacherDocsInfo.docTypeID}" theme="simple" name="teacherDocsInfo.docTypeID"></s:select>
			</td>
		</tr>
		<tr>
			<td class="text">材料名称</td>
			<td><input type="text"  name="teacherDocsInfo.docName" value="${teacherDocsInfo.docName}"></td>
			<td class="text">形成日期</td>
			<td><input type="text"  name="teacherDocsInfo.formationDate" value="${teacherDocsInfo.formationDate}"></td>
		</tr>
		<tr>
			<td class="text">份数</td>
			<td><input type="text"  name="teacherDocsInfo.copys" value="${teacherDocsInfo.copys}"></td>
			<td class="text">页数</td>
			<td><input type="text"  name="teacherDocsInfo.pages" value="${teacherDocsInfo.pages}"></td>
		</tr>
		<tr>
			<td class="text">顺序号</td>
			<td><input type="text"  name="teacherDocsInfo.orderID" value="${teacherDocsInfo.orderID}"></td>
			<td class="text"></td>
			<td></td>
		</tr>
	</table>
