	...
	<body class="bg_color" style="margin-top:4px">
        	<div style="width:100%;overflow:auto; height:100%;">
				<table align="center" class="back_border" width="98%" style="height:80px;" cellpadding="0" cellspacing="0">
				    <tr>
				        <td class="bg_title bg_title4" align="center">存毁鉴定详细信息</td>
				    </tr>
				    <tr>
				        <td>
				            <table width="100%">
				              	<tr>
						        	...
						        	<td>${appraisalKeepDestroyDetail.archivesID}</td>
						        </tr>
						        <tr>
						        	<td align="right">题名:</td>
						        	<td>${appraisalKeepDestroyDetail.title}</td>
						        </tr>
						        <tr>
						        	<td align="right">鉴定人:</td>
						        	<td>${appraisalKeepDestroyDetail.appraisalPersion}</td>
						        </tr>
						        <tr>
						        	<td align="right">鉴定日期:</td>
						        	<td><fmt:formatDate value="${appraisalKeepDestroyDetail.appraisalDate}" type="date"/></td>
						        </tr>
						         <tr>
						        	<td align="right">鉴定依据:</td>
						        	<td><textarea id="content" readonly="readonly" name="content" rows="5" style="width:90%;">${appraisalKeepDestroyDetail.appraisalReason}</textarea></td>
						        </tr>
						      </table>
				        </td>
				    </tr>
