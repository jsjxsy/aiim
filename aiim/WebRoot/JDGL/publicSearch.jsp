	...
	//////////////////单击事件////////////////////////
		...
		//显示详情
		 function showDetail(idObj){
			 var url = "archiveAppraisalAction_publicSearchDetail.action?appraisalDetailId="+idObj;
			 showWinModalDialog(url ,'500px' ,'300px');
		 }
	</script>
</head>
  
<s:form id="conditionForm" name="conditionForm" action="archiveAppraisalAction_publicSearch" namespace="/JDGL">
			...
			<tr>
				<td>
					...
					<div style="margin-right:2px; color:blue; display:block; width:300px; float:right; margin-top:5px;" align="right">
						<font style="font-size:12px;font-weight:bold;">当前位置：</font>鉴定登记信息&nbsp;&gt;&gt;&nbsp;开放鉴定
					</div>					
				</td>
			</tr>
			<tr>
			...
			<tr id="tr_title" style="display: none;">
				<td>
					<table class="tabletop" width="100%">
						<tr>
			                <td class="tableTitle">开放鉴定登记信息</td>
