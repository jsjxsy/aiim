...
List results = (List)request.getAttribute("appraisalPublicDetails");
%>
	...
	//////////////////单击事件////////////////////////
		...
		//显示详情
		 function showDetail(idObj){
			 var url = "archiveAppraisalAction_openSearchDetail.action?appraisalDetailId="+idObj;
			 showWinModalDialog(url ,'500px' ,'300px');
		 }
	</script>
</head>
  
<s:form id="conditionForm" name="conditionForm" action="archiveAppraisalAction_openSearch" namespace="/JDGL">
			...
			<tr>
				<td>
					...
					<div style="margin-right:2px; color:blue; display:block; width:300px; float:right; margin-top:5px;" align="right">
						<font style="font-size:12px;font-weight:bold;">当前位置：</font>鉴定登记信息&nbsp;&gt;&gt;&nbsp;公开鉴定
					</div>					
				</td>
			</tr>
			<tr>
			...
			<tr id="tr_title" style="display: none;">
				<td>
					<table class="tabletop" width="100%">
						<tr>
			                <td class="tableTitle">公开鉴定登记信息</td>
			...
			<tr id="tr_showTable" style="display: none;">
				<td>
					<table id="showTable" width="100%" style="margin:0px; border: #104da6 1px solid;" cellspacing="1px" cellpadding="0px" >						
						...
						<tbody id="checkList">
							<s:iterator value="#request.appraisalPublicDetails" var="entity" status="stau">
								...
								<s:else>
									...
									<td><s:property value="#entity.oldSecrecyName"/></td>
