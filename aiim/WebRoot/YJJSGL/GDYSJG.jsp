...
<html>
  ...
  //单击案卷行，改变颜色，显示卷内文件列表
	...
	//<input type="hidden" name="deptType" value="XCBM"/>
	//打开当前的移交清单
  ...
  <body>
    ...
    <form name="conditionForm" id="conditionForm" action="YJGL/YJJSAction_findArchivesForYWZDSGDYS.action" method="post" style="margin: 0;padding: 0;">
		...
		<tr>
			...
			<td>
				<div id="location" style="margin-right: 2px; width: 280px; display: inline-block; float: right; margin-top: 5px; color: blue; text-align: right;">
					<font style="font-size: 12px;"><b>当前位置：</b>移交管理&nbsp;&gt;&gt;&nbsp;&nbsp;归档验收结果</font>
				</div>
			</td>
		</tr>
	</table>
	...
	<input type="hidden" id="deptType" name="deptType" value="YWZDS"/>
	<input type="hidden" id="archivesTypeID" name="archivesTypeID" value="${requestScope.archivesTypeID }"/>
