		...
		<table width="100%" style="margin:0px;" align="center">
			...
			<tr>
			  <td align="center" id="find" style="display:none; width:100%;">
			     <fieldset>
			       <s:if test="#request.deptId != null">
			        <form action="YJGL/YJJSAction_findReceivedOutside.action" name="conditionForm" method="post" style="margin: 0px; padding: 0px;" onsubmit="return checkForm()">
			        <input type="hidden" name="nodeId" id="deptId" value="${deptId }"/> 
			       </s:if>
			       <s:else>
			        <form action="YJGL/YJJSAction_findReceivedInside.action" name="conditionForm" method="post" style="margin: 0px; padding: 0px;" onsubmit="return checkForm()">
			        <input type="hidden" name="nodeId" id="userId" value="${userID }"/> 
			       </s:else>
