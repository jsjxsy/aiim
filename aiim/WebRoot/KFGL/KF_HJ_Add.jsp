...
<html>
  ...
  <form name="inputForm" action="KFGL/storeroomManageAction_registerTempratureHumidityInfo.action" method="post" >
...
<table cellspacing="0" cellpadding="0" style="margin-left:10px;">
	<tr>
		<td style="width: 340px;font-size: 12px;">注：温度单位是°C，湿度单位是%。</td>
		<td><input type="button" <s:if test="#request.successFlg==true">disabled="disabled"</s:if> style="margin-left:50px;"  value=" 保存 " onclick="validate()"/><input type="button" style="margin-left:6px;margin-right: 15px;" <s:if test="#request.successFlg==true">value=" 退出 " </s:if><s:else>value=" 取消 " </s:else>  onclick="clickClose();"/></td>
	</tr>
</table>
</form>
  </body>
