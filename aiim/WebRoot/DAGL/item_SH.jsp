...
//单击事件////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//通过
    function checkPass(){
    	ArchivesInfoManageDWR.checkPass(archivesTypeID,NBXHS[0],checkPassCallBack); 
    }
    function checkPassCallBack(data){
       if(data == 1){
    	   window.returnValue=1;
           window.close();
       }
	...
	//打回
	function checkOut(){
		var returnValue = window.showModalDialog("SHDH.jsp","newwindow","dialogWidth=500px;dialogHeight:240px;center=yes;help=no;resizable=no;status=no;scroll=no;");
		if(returnValue != null){
			ArchivesInfoManageDWR.checkBack(archivesTypeID,NBXHS[0],returnValue,checkBackCallBack); 
		}
    }
...
<body onload="init()" style="margin:0px; background-color:#f9f9f9; text-align: center;">
   ...
   <table align="center" width="100%">
      <tr>
         <td align="center"><input type="button" value="通      过" class="button" onclick="checkPass()"/>	<input type="button"  value="打      回" class="button" onclick="checkOut()" style="margin-left: 15px;"/></td>
      </tr>
  </table> 	
</body>
</html>
