...
<script type="text/javascript"src="dwr/interface/UserChargeUserInfoManageDWR.js"></script>
...
function saveUserChargeUserInfo(){
	...
	if(UserIDS.length <= 0){
		alert("请选择要添加的用户代理!");
			...
			UserChargeUserInfoManageDWR.saveUserChargeUserInfo(UserIDS,UserID,saveUserChargeUserInfoCallBack);
		}
   }
			...
			<tr>
				<td>
					<input type="image" src="images/find.gif"
								...
								<font style="font-size:12px;font-weight:bold;">当前位置：</font>账户管理&nbsp;&gt;&gt; 代理用户列表</div >	
			</tr>
			<tr>
			  <td align="center">
			    <div id="findDiv" style="display:none; width:100%;margin-top:3px; height:150px;">
			      <fieldset>
			      <form action="XTGL/userInfoManageAction_findAllUserUnchargeUserInfos.action" id="conditionForm" name="conditionForm">
			       ...
			       <input type="hidden" name="dataPageInfo.currentPage"
					...
					<tr style="height: 26px" align="right">
			         ...
			         <tr style="height:40px;">
			          ...
			          <label style="width:100px;">&nbsp;</label></td>
			         </tr>
			       </table>
			       </form>
			     </fieldset>
