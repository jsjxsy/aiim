				...
				<tr>
					<td align="center">
						<table class="back_border" width="98%" style="height:80px;" cellpadding="0" cellspacing="0">
						    ...
						    <tr>
						        <td>
						            <table width="100%">
								        <tr>
								            <td class="text">姓名sdfasdf</td>
									        <td align="left">
										        <input id="name" type="text" onchange="clearUserID()" name="userRealName" value="${archivesUseRegister.archivesUsePersonInfo.name }"/><input id="findByName" type="button"  value="|"/></td>
						...
						<form action="DALY/archivesUseAction_useRegist.action" method="post" style="margin: 0;padding: 0">
							        ...
							        <td>
							            <table width="100%">
									        <tr>
										        ...
										        <td class="text" width="85px;">应还时间</td>
										        <td align="left">
									        ...
									        <tr>
										        ...
										        <td align="left">
											        <input type="text"  id="use_mode" value="${useTypeText }" readonly="readonly"/></td>
										        <td class="text" width="85px;">利用目的</td>
										        <td align="left">
									        ...
									        <tr>
										        ...
										        <td colspan="3" align="left">
											        <textarea  id="remark" name="remark" style="width:87.7%;">${archivesUseRegister.remark }
											        </textarea>
											   </td>
									        </tr>
									        <tr>
							...
							<input type="image" src="images/DYCHD.gif" onmouseover="changeImage(this,'DYCHD1.gif')" onmouseout="changeImage(this,'DYCHD.gif')"/>
							<!-- 
