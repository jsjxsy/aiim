...
function print()
{
	window.showModalDialog(
			"printReportResultArchivesTypeUse.action",
			 window,
...
<body>
						...
						<tr>
							<td>
								...
								<div style="margin-right: 2px; display: block; width: 280px; float: right; margin-top: 5px; color: blue; text-align: right;">
									<font style="font-size: 12px; font-weight: bold;">当前位置：</font>统计报表结果&nbsp;&gt;&gt;&nbsp;&nbsp;档案分类利用情况 
								</div>
							</td>
						</tr>
					</table>
								...
								<table style="width:100%;height:25px;" cellspacing="0" cellpadding="0">
							            <tr>
						                  <td>
					                	    ...
					                	    <div align="center">
					                	      <label style="margin-right:4px;font-weight: bold;font-size:<s:property value="#request.reportPrintSettings[0].titleFontSize"/>px;" id="rsInfo"><s:property value="#request.reportResultArchivesTypeUses[0].reportTitle"/></label>
				                	        </div></td>
					                    </tr>
							    </table>
							</td>
  ...
  <table width="100%">
 	 <tr>
 	 	<td align="right">
 	 <input type="button"  value="Excel导出" name="excel" id="excel" onclick="javascript:window.location.href='excel_exportReportResultArchivesTypeUseExcel.action'"/>
  		</td>
  	</tr>
  </table>
</body>
