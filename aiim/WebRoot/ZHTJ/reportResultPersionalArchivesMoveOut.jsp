...
function print()
{
	window.showModalDialog(
			"printReportResultPersionalArchivesMoveOut.action",
			 window,
...
<table id="userInfo" cellpadding="0" cellspacing="0"
			...
			<table width="100%" style="margin: 0px;" cellspacing="0"
				...
				<tr>
					...
					<div style="margin-right: 2px; display: block; width: 280px; float: right; margin-top: 5px; color: blue; text-align: right;">
						<font style="font-size: 12px; font-weight: bold;">当前位置：</font>统计报表结果&nbsp;&gt;&gt;&nbsp;&nbsp;人事档案转出情况
					</div>
				</td>
			</tr>
		</table>
				            ...
				            <tr>
			                  <td>
		                	    ...
		                	    <div align="center">
		                	      ...
		                	      <s:property value="#request.reportResultPersionalArchivesMoveOuts[0].reportTitle"/></label>
	                	        </div></td>
		                    </tr>
				    </table>
				</td>
	...
	<table id="showTable" width="100%" style="margin:0px; border: #104da6 1px solid;" cellspacing="1px" cellpadding="0px" >						
		<thead class="tableHead">
			<tr class="bgTitle">
				<th width="33%">人事档案具体子类名称</th>	
				<th width="33%">总卷数</th>
			</tr>
		</thead>
		<tbody>
		<s:iterator var="reportResultPersionalArchivesMoveOut" value="#request.reportResultPersionalArchivesMoveOuts">
   ...
   <table width="100%">
 	 <tr>
 	 	<td align="right">
 	 <input type="button"  value="Excel导出" name="excel" id="excel" onclick="javascript:window.location.href='excel_exportReportResultPersionalArchivesMoveOutExcel.action'"/>
  		</td>
  	</tr>
  </table>
</body>
