...
function print()
{
	window.showModalDialog(
			"printReportResultWorkProcedure.action",
			 window,
				...
				<td>
						...
						<tr>
							<td>
								...
								<div style="margin-right: 2px; display: block; width: 280px; float: right; margin-top: 5px; color: blue; text-align: right;">
									<font style="font-size: 12px; font-weight: bold;">当前位置：</font>统计报表结果&nbsp;&gt;&gt;&nbsp;&nbsp;工作情况 
								</div>
							</td>
						</tr>
					</table>
							            ...
							            <tr>
						                  <td>
					                	    ...
					                	    <div align="center">
					                	      ...
					                	      <s:property value="#request.reportResultWorkProcedures[0].reportTitle"/></label>
				                	        </div></td>
					                    </tr>
							    </table>
							</td>
					...
					<table id="showTable" width="100%" style="margin:0px; border: #104da6 1px solid;" cellspacing="1px" cellpadding="0px" >						
						<thead class="tableHead">
							<tr class="bgTitle">
								<th width="14.2%">真实姓名 </th>								
								<th width="14.2%">著录条目数  </th>
								<th width="14.2%">著录提交送审条目数</th>
								<th width="14.2%">实物档案馆外移交数量 </th>
								<th width="14.2%">业务指导室接收审核数量</th>
								<th width="14.2%">实物档案馆内移交数量 </th>
								<th width="*%">档案管理室接收审核数量 </th>
							</tr>
						</thead>
						<tbody>
...
<table width="100%">
 	 <tr>
 	 	<td align="right">
 	 <input type="button"  value="Excel导出" name="excel" id="excel" onclick="javascript:window.location.href='excel_exportReportResultWorkProcedureExcel.action'"/>
		</td>
	</tr>
</table>
</body>
