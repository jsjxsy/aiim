...
function print()
{
	window.showModalDialog(
			"printReportResultArchivesCollection.action",
			 window,
			...
			<tr>
				<td>
						...
						<tr>
							<td>
								...
								<div style="margin-right: 2px; display: block; width: 280px; float: right; margin-top: 5px; color: blue; text-align: right;">
									<font style="font-size: 12px; font-weight: bold;">当前位置：</font>统计报表结果&nbsp;&gt;&gt;&nbsp;&nbsp;案卷档案馆藏情况
								</div>
							</td>
						</tr>
					</table>
							            ...
							            <tr>
						                  <td>
					                	    ...
					                	    <div align="center">
					                	      ...
					                	      <s:property value="#request.reportResultArchivesCollections[0].reportTitle"/></label>
				                	        </div></td>
					                    </tr>
							    </table>
							</td>
					...
					<table id="showTable" width="100%" style="margin:0px; border: #104da6 1px solid;" cellspacing="1px" cellpadding="0px" >						
						...
						<s:iterator var="reportResultArchivesCollection" value="#request.reportResultArchivesCollections">
							<tr bgcolor="#e0edff" id="row1" style="font-size: <s:property value="#request.reportPrintSettings[0].tableFontSize"/>px;">
								<td height="<s:property value="#request.reportPrintSettings[0].tableRowHeight"/>"><s:property value="archivesFondsName"/></td>
				  ...
				  <table width="100%">
				 	 <tr>
				 	 	<td align="right">
				 	 <input type="button"  value="Excel导出" name="excel" id="excel" onclick="javascript:window.location.href='excel_exportReportResultArchivesCollectionExcel.action'"/>
				  		</td>
				  	</tr>
				  </table>
</body>
