...
function print()
{
	window.showModalDialog(
			"printReportResultArchivesDestroy.action",
			 window,
...
<body>
				...
				<td>
						...
						<tr>
							<td>
								...
								<div style="margin-right: 2px; display: block; width: 280px; float: right; margin-top: 5px; color: blue; text-align: right;">
									<font style="font-size: 12px; font-weight: bold;">当前位置：</font>统计报表结果&nbsp;&gt;&gt;&nbsp;&nbsp;档案销毁情况
								</div>
							</td>
						</tr>
					</table>
							            ...
							            <tr>
						                  <td>
					                	    ...
					                	    <div align="center">
					                	      ...
					                	      <s:property value="#request.reportResultArchivesDestroys[0].reportTitle"/></label>
				                	        </div></td>
					                    </tr>
							    </table>
							</td>
					...
					<table id="showTable" width="100%" style="margin:0px; border: #104da6 1px solid;" cellspacing="1px" cellpadding="0px" >						
						<thead class="tableHead">
							<tr class="bgTitle">
								<th width="20%">一级类目名称</th>								
								<th width="20%">年度总卷数 </th>
								<th width="20%">年度总件数 </th>
								<th width="20%">历史累计卷数</th>
								<th width="20%">历史累计件数</th>
							</tr>
						</thead>
						<tbody>
						<s:iterator var="reportResultArchivesDestroy" value="#request.reportResultArchivesDestroys">
							<tr bgcolor="#e0edff" id="row1" style="font-size: <s:property value="#request.reportPrintSettings[0].tableFontSize"/>px;">
								...
								<td><s:property value="historyColumeCount "/></td>
								<td><s:property value="historyPieceCount "/></td>
							</tr>		
						</s:iterator>
						</tbody>
				  </table>
  <table width="100%">
 	 <tr>
 	 	<td align="right">
 	 <input type="button"  value="Excel导出" name="excel" id="excel" onclick="javascript:window.location.href='excel_exportReportResultArchivesDestroyExcel.action'"/>
  		</td>
  	</tr>
  </table>
</body>
