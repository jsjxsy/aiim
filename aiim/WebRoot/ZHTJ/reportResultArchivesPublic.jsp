...
function print()
{
	window.showModalDialog(
			"printReportResultArchivesPublic.action",
			 window,
...
<body>
			...
			<tr>
				<td>
						...
						<tr>
							<td>
								...
								<div style="margin-right: 2px; display: block; width: 280px; float: right; margin-top: 5px; color: blue; text-align: right;">
									<font style="font-size: 12px; font-weight: bold;">当前位置：</font>统计报表结果&nbsp;&gt;&gt;&nbsp;&nbsp;档案开放情况
								</div>
							</td>
						</tr>
					</table>
							            ...
							            <tr>
						                  <td>
					                	    ...
					                	    <div align="center">
					                	      ...
					                	      <s:property value="#request.reportResultArchivesPublics[0].reportTitle"/></label>
				                	        </div></td>
					                    </tr>
							    </table>
							</td>
					...
					<table id="showTable" width="100%" style="margin:0px; border: #104da6 1px solid;" cellspacing="1px" cellpadding="0px" >						
						...
						<tbody>
						<s:iterator var="reportResultArchivesPublic" value="#request.reportResultArchivesPublics">
  ...
  <table width="100%">
 	 <tr>
 	 	<td align="right">
 	 <input type="button"  value="Excel导出" name="excel" id="excel" onclick="javascript:window.location.href='excel_exportReportResultArchivesPublicExcel.action'"/>
  		</td>
  	</tr>
  </table>
</body>
