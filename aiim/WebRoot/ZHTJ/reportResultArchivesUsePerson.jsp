...
function print()
{
	window.showModalDialog(
			"printReportResultArchivesUsePerson.action",
			 window,
...
<body>
				...
				<td>
						...
						<tr>
							<td>
								...
								<div style="margin-right: 2px; display: block; width: 280px; float: right; margin-top: 5px; color: blue; text-align: right;">
									<font style="font-size: 12px; font-weight: bold;">当前位置：</font>统计报表结果&nbsp;&gt;&gt;&nbsp;&nbsp;档案利用人情况
								</div>
							</td>
						</tr>
					</table>
								...
								<table style="width:100%;height:25px;" cellspacing="0" cellpadding="0">
							            <tr>
						                  <td>
					                	    ...
					                	    <div align="center">
					                	      <label style="margin-right:4px;font-weight: bold;font-size:<s:property value="#request.reportPrintSettings[0].titleFontSize"/>px;" id="rsInfo"><s:property value="#request.reportResultArchivesUsePersons[0].reportTitle"/></label>
				                	        </div></td>
					                    </tr>
							    </table>
							</td>
					...
					<table id="showTable" width="100%" style="margin:0px; border: #104da6 1px solid;" cellspacing="1px" cellpadding="0px" >						
						<thead class="tableHead">
							<tr class="bgTitle">
								<th width="25%">利用人区域信息</th>								
								<th width="25%">人次总数量</th>
							</tr>
						</thead>
						<tbody>
  ...
  <table width="100%">
 	 <tr>
 	 	<td align="right">
 	 <input type="button"  value="Excel导出" name="excel" id="excel" onclick="javascript:window.location.href='excel_exportReportResultArchivesUsePersonExcel.action'"/>
  		</td>
  	</tr>
  </table>
</body>
