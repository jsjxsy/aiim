...
function print()
{
	window.showModalDialog(
			"printReportResultTempratureHumidityForMonth.action",
			 window,
						...
						<tr>
							<td>
								...
								<div style="margin-right: 2px; display: block; width: 300px; float: right; margin-top: 5px; color: blue; text-align: right;">
									<font style="font-size: 12px; font-weight: bold;">当前位置：</font>统计报表结果&nbsp;&gt;&gt;&nbsp;&nbsp;库房温湿度月度变化情况
								</div>
							</td>
						</tr>
					</table>
							            ...
							            <tr>
						                  <td>
					                	    ...
					                	    <div align="center">
					                	      ...
					                	      <s:property value="#request.reportResultTempratureHumidityForMonths[0].reportTitle"/></label>
				                	        </div></td>
					                    </tr>
							    </table>
							</td>
...
<table width="100%">
 	 <tr>
 	 	<td align="right">
 	 <input type="button"  value="Excel导出" name="excel" id="excel" onclick="javascript:window.location.href='excel_exportReportResultTempratureHumidityForMonthExcel.action'"/>
		</td>
	</tr>
</table>
</body>
