...
<title>统计报表结果--库房温湿度年度变化情况</title>
...
function print()
{
	window.showModalDialog(
			"printReportResultTempratureHumidityForYear.action",
			 window,
			...
			<tr>
				<td>
					<table width="100%" style="margin: 0px;" cellspacing="0"
						...
						<tr>
							<td>
								...
								onclick="print()" />
								<div style="margin-right: 2px; display: block; width: 300px; float: right; margin-top: 5px; color: blue; text-align: right;">
									<font style="font-size: 12px; font-weight: bold;">当前位置：</font>统计报表结果&nbsp;&gt;&gt;&nbsp;&nbsp;库房温湿度年度变化情况
								</div>
							</td>
						</tr>
					</table>
							            ...
							            <tr>
						                  <td>
					                	    ...
					                	    <div align="center">
					                	      ...
					                	      <s:property value="#request.reportResultTempratureHumidityForYears[0].reportTitle"/></label>
				                	        </div></td>
					                    </tr>
							    </table>
							</td>
					...
					<table id="showTable" width="100%" style="margin:0px; border: #104da6 1px solid;" cellspacing="1px" cellpadding="0px" >						
						...
						<tbody>
						<s:iterator var="reportResultTempratureHumidityForYear" value="#request.reportResultTempratureHumidityForYears">
...
<table width="100%">
 	 <tr>
 	 	<td align="right">
 	 <input type="button"  value="Excel导出" name="excel" id="excel" onclick="javascript:window.location.href='excel_exportReportResultTempratureHumidityForYearExcel.action'"/>
		</td>
	</tr>
</table>
</body>
