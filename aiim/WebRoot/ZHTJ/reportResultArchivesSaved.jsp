...
function print()
{
	window.showModalDialog(
			"printReportResultArchivesSaved.action",
			 window,
...
<body>
						...
						<tr>
							<td>
								...
								<div style="margin-right: 2px; display: block; width: 280px; float: right; margin-top: 5px; color: blue; text-align: right;">
									<font style="font-size: 12px; font-weight: bold;">当前位置：</font>统计报表结果&nbsp;&gt;&gt;&nbsp;&nbsp;档案归档情况
								</div>
							</td>
						</tr>
					</table>
							            ...
							            <tr>
						                  <td>
					                	    ...
					                	    <div align="center">
					                	      ...
					                	      <s:property value="#request.reportResultArchivesSaveds[0].reportTitle"/></label>
				                	        </div></td>
					                    </tr>
							    </table>
							</td>
  ...
  <table width="100%">
 	 <tr>
 	 	<td align="right">
 	 <input type="button"  value="Excel导出" name="excel" id="excel" onclick="javascript:window.location.href='excel_exportReportResultArchivesSavedExcel.action'"/>
  		</td>
  	</tr>
  </table>
</body>
