 ...
 * 
 */
public class ArchivesInfoQueryCondition
{
	 ...
	 *            当前查询条件对应的数据项
	 */
	public ArchivesInfoQueryCondition(ArchivesTypeDataItem dataItem)
	{
	 ...
	 *            是否为与运算(AND)
	 */
	public ArchivesInfoQueryCondition(ArchivesTypeDataItem dataItem, EnumOperatorType operatorType, String value, boolean isAND)
	{
		this(dataItem);
